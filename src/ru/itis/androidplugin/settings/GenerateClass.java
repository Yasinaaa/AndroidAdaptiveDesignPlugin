...
public class GenerateClass {
    ...
    public void generateClass(String name){
        ...
        //try {
            ...
            CodeGenerationPattern pattern = generationPattern.create();
            ...
            final String outputClassName = name + "." + className;
    ...
    private Editor getEditor() {
        ...
        if(PluginProject.mProject == null) return null;
        else
    ...
    {
        patternName = generationPattern.create().getName();
    }
